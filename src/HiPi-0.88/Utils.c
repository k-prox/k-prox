...
XS_EUPXS(XS_HiPi__Utils__drop_permissions_id); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_HiPi__Utils__drop_permissions_id)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
       croak_xs_usage(cv,  "touid, togid = -1");
    {
	int	touid = (int)SvIV(ST(0))
;
	int	togid;
...
extern "C" {
#endif
XS_EXTERNAL(boot_HiPi__Utils); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_HiPi__Utils)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
...
#  endif
        ...
        newXS_deffile("HiPi::Utils::_drop_permissions_id", XS_HiPi__Utils__drop_permissions_id);
#if PERL_VERSION_LE(5, 21, 5)
